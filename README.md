...
## 📸 Prints do Caderno no NotebookLM

![Minhas fontes carregadas no NotebookLM](docs/print-fontes.png)
![Pergunta com citação das fontes](docs/print-pergunta.png)
![Resumo gerado pela IA](docs/print-resumo.png)
